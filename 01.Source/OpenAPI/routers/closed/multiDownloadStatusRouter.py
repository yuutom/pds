...
# 自作クラス
## 業務ロジッククラス
from models.closed.multiDownloadStatusModel import multiDownloadStatusClass
## utilクラス
...
# 処理名
EXEC_NAME: str = "multiDownloadStatus"
EXEC_NAME_JP: str = "個人情報一括DL状況確認"
...
# 個人情報一括DL状況確認API
@router.post("/api/2.0/transaction/download/status")
async def tf_operator_create(
    ...
    try:
        ...
        # モデルオブジェクト作成
        multi_download_status_model = multiDownloadStatusClass(trace_logger)

        # main関数実行
        main_result = multi_download_status_model.main(request_body)
        ...
        response_content = {
            ...
            "multiDownloadInfo": main_result["multi_download_info_list"]
        }
